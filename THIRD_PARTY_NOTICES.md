...
| WINSPAR Windows TCP Optimizer by powplowdevs | https://github.com/powplowdevs/WINSPAR-Windows-TCP-Optimizer/tree/6392524fcd51925ffe0e082a76facf5b3bb8f322 | AGPL-3.0; reviewed only as a behavioral reference for TCP state, manual controls, application QoS, diagnostics and backup/restore. ZapTweaks' native MIT implementation must be clean-room: no upstream C++/Java/Python code, binaries, test payloads or artwork is copied, bundled or executed. |
