  ...
  static const Map<String, Map<String, String>> _categories =
      <String, Map<String, String>>{
        'it': <String, String>{
          ...
          'Apps': 'App',
          'Drivers': 'Driver',
          'Gaming & Performance': 'Gaming e prestazioni',
          'Diagnostics & Recovery': 'Diagnostica e ripristino',
          'Expert': 'Esperto',
        ...
        'de': <String, String>{
          ...
          'Apps': 'Apps',
          'Drivers': 'Treiber',
          'Gaming & Performance': 'Gaming und Leistung',
          'Diagnostics & Recovery': 'Diagnose und Wiederherstellung',
          'Expert': 'Experte',
        ...
        'es': <String, String>{
          ...
          'Diagnostics & Recovery': 'Diagnóstico y recuperación',
          'Expert': 'Experto',
        ...
        'fr': <String, String>{
          ...
          'Apps': 'Applications',
          'Drivers': 'Pilotes',
          'Gaming & Performance': 'Jeux et performances',
          'Diagnostics & Recovery': 'Diagnostic et récupération',
          'Expert': 'Expert',
        ...
        'ru': <String, String>{
          ...
          'Diagnostics & Recovery': 'Диагностика и восстановление',
          'Expert': 'Эксперт',
          'Shortcuts': 'Ярлыки',
          'Gaming': 'Игры',
          'Networking': 'Сеть',
        ...
        'zh': <String, String>{
          ...
          'Apps': '应用',
          'Drivers': '驱动程序',
          'Gaming & Performance': '游戏与性能',
          'Diagnostics & Recovery': '诊断与恢复',
          'Expert': '专家',
          'Shortcuts': '快捷方式',
          'Gaming': '游戏',
          'Networking': '网络',
