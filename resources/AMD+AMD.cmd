...
echo ================================================
echo    Ottimizzazione Gaming Sistema AMD Ryzen/AMD Radeon
echo ================================================
echo.
echo Sistema Target: Ryzen + AMD Radeon
echo.
...
echo.
echo [5/11] Ottimizzazioni GPU AMD
...
:: Hardware Accelerated GPU Scheduling disabilitato (migliore per AMD)
...
echo - RAM: GB ottimizzati, paging executive off
