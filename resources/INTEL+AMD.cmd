...
:: Sistema: Intel Core + AMD Radeon RX
:: Esegui come AMMINISTRATORE

echo ================================================
echo    Ottimizzazione Gaming Sistema Intel/AMD
echo ================================================
echo.
echo Sistema Target: Intel Core + AMD Radeon RX
echo.
...
echo.
echo [2/11] CPU Unparking - Tutti i thread Intel...
...
echo CPU Unparking completato.


:: INTEL SPECIFICO - Heterogeneous Thread Scheduling Policy (12th gen+)
:: 0 = Preferisci E-cores, 3 = Preferisci P-cores, 4 = Automatic
:: Per gaming
powercfg -setacvalueindex scheme_current sub_processor HETEROPOLICY 4

powercfg -setactive scheme_current

echo CPU unparked, scaling dinamico attivo.
...
echo.
echo [5/11] Ottimizzazioni GPU AMD RX
...
:: TdrDelay aumentato (evita reset driver durante carichi pesanti)
reg add "HKLM\SYSTEM\CurrentControlSet\Control\GraphicsDrivers" /v "TdrDelay" /t REG_DWORD /d "60" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Control\GraphicsDrivers" /v "TdrDdiDelay" /t REG_DWORD /d "60" /f

:: AMD Specifico - Disabilita ULPS (Ultra Low Power State)
...
:: AMD - Disabilita Power Play (mantiene frequenze alte)
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "PP_SclkDeepSleepDisable" /t REG_DWORD /d "1" /f
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "PP_ThermalAutoThrottlingEnable" /t REG_DWORD /d "0" /f

:: AMD - Disabilita DRR (Dynamic Refresh Rate) per latenza costante
...
echo GPU AMD Radeon ottimizzata.
...
echo - CPU: 24 thread unparked, C-States disabilitati
echo - GPU: Priorità massima, preemption disabilitata
echo - RAM: 64GB ottimizzati, paging executive off
