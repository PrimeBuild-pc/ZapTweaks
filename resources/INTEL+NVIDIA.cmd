...
echo ================================================
echo    Ottimizzazione Gaming Sistema Intel/NVIDIA
echo ================================================
echo.
echo Sistema Target: Intel + NVIDIA RTX
echo.
...
echo.
echo [5/11] Ottimizzazioni GPU NVIDIA RTX...
...
:: Disabilita preemption (riduce latenza GPU)


:: Hardware Accelerated GPU Scheduling (HAGS) - Abilitato per NVIDIA
...
:: ClearPageFileAtShutdown disabilitato
...
:: Disabilita aggiornamnrenti automatici driver
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\DriverSearching" /v "SearchOrderConfig" /t REG_DWORD /d "0" /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate" /v "ExcludeWUDriversInQualityUpdate" /t REG_DWORD /d "1" /f

echo Windows Update ottimizzato.
...
echo - CPU: thread unparked, scaling dinamico attivo
